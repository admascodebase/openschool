...
public class LoadDto implements Serializable{
	...
	public Load _toJpa(){
		Load load = new Load();
		load.setAdvance(this.advance);
		
		load.setCompId(this.compId);
		load.setAdvance(this.advance);
		load.setAmount(this.amount);
		load.setBalance(this.balance);
		load.setRouteId(this.companyRouteDto._toJpa());
		load.setCreatedBy(this.createdBy);
		load.setCreatedOn(this.createdOn);
		load.setDelFlag(this.delFlag);
		load.setId(this.compId);
		load.setLoadingDate(this.loadingDate);
		load.setTransportTypeDtlId(this.transportTypeDtlDto._toJpa());
		load.setUnloadingDate(this.unloadingDate);
		load.setUpdatedBy(this.updatedBy);
		load.setUpdatedOn(this.updatedOn);
