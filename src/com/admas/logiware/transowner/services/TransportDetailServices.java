...
public class TransportDetailServices {
	...
	/**
	 * @param transOwnerLogicImpl
	 *            the transOwnerLogicImpl to set
	 */
	public static void setTransOwnerLogicImpl(
			TransOwnerLogic transOwnerLogicImpl) {
		TransportDetailServices.transOwnerLogicImpl = transOwnerLogicImpl;
	}
	...
	public Response getTransportDetail(@PathParam("transOwnerId") Integer transOwnerId) {
		...
		logger.info(" end  TransportDetailServices- > getAllTransOwner");
	...
	public Response getTransOwnerById(@PathParam("id") Integer transOwnerId) {
		...
		try {
			loweryOwnerDto = transOwnerLogicImpl
					.getTransOwnerById(transOwnerId);
			logiwareRespnse.setCode(LogiWareConstants.SUCESS);
