...
@Repository
public class TransOwnerDaoImpl implements TransOwnerDao {

	private static EntityManager entityManager;
	Logger logger = LoggerFactory.getLogger(TransOwnerDaoImpl.class);


	@PersistenceContext
	public void setEntityManager(EntityManager entityManager) {
		TransOwnerDaoImpl.entityManager = entityManager;
	}

	/**
	 * 
	 */
	public TransOwnerDaoImpl() {
