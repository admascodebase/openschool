...
<!-- Mirrored from mariusn.com/themes/reales-wp/contact-us/ by HTTrack Website Copier/3.x [XR&CO'2013], Fri, 25 Sep 2015 12:40:21 GMT -->
<!-- Added by HTTrack -->
...
<title>Contact Us | Reales WP</title>
<link rel="pingback"
...
<link rel='shortlink'
	href='${pageContext.request.contextPath}/resources/PropertyPortal/assets/index728e.html?p=517' />
<style type='text/css'>
.slideshowShadow {
...
<body
	class="page page-id-517 page-template page-template-contact-page page-template-contact-page-php no-transition">

	<div id="page-hero-container">
		<div class="page-hero"
			style="background-image:url(${pageContext.request.contextPath}/resources/PropertyPortal/assets/wp-content/uploads/2014/12/there_is_oil_in_the_fields-wallpaper-1920x1080.jpg)"></div>
                        ...
                        (function(d, s, id) {
                            ...
                            fjs.parentNode.insertBefore(js, fjs);
								...
								<input type="hidden" id="securitySignin" name="securitySignin"
									...
									name="_wp_http_referer" value="/themes/reales-wp/contact-us/" />
								<div class="form-group">
									<div class="btn-group-justified">
						...
						<div class="modal-body">
							<form role="form" id="userResetPassForm" method="post">
								...
								<input type="hidden" id="securityResetpass"
									...
									value="/themes/reales-wp/contact-us/" />
								<div class="form-group">
									<div class="btn-group-justified">
			...
			<div class="top-nav">
				<div class="menu-top-menu-container">
					<ul id="menu-top-menu" class="menu">
						...
						<li id="menu-item-519"
							class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-517 current_page_item menu-item-519"><a
		...
		<div class="page-content">
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
					...
					<div id="post-517"
						class="post-517 page type-page status-publish has-post-thumbnail hentry">
						<h2 class="pageHeader">ADMAS Company</h2>

						<!--                     <div class="row pb20">
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                            <h4>Contact Details</h4>
                                                            <div class="contact-details"><span class="contact-icon fa fa-phone"></span>  (123) 456-7890</div>
                                                                                        <div class="contact-details"><span class="contact-icon fa fa-mobile"></span>  (123) 456-7890</div>
                                                                                        <div class="contact-details"><span class="contact-icon fa fa-envelope-o"></span> n3sty.marius@gmail.com</div>
                                                                                        <div class="contact-details"><span class="contact-icon fa fa-skype"></span> n3sty.marius</div>
                                                                                        <div class="contact-details"><span class="contact-icon fa fa-map-marker"></span> 196 Front St, San Francisco, CA 94111, United States</div>
                                                    </div>
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                                            <h4>Follow Us</h4>
                                                                    <div class="contact-details"><a href="#" class="text-facebook"><span class="contact-icon fa fa-facebook"></span> Facebook</a></div>
                                                                                                    <div class="contact-details"><a href="#" class="text-twitter"><span class="contact-icon fa fa-twitter"></span> Twitter</a></div>
                                                                                                    <div class="contact-details"><a href="#" class="text-google"><span class="contact-icon fa fa-google-plus"></span> Google+</a></div>
                                                                                                    <div class="contact-details"><a href="#" class="text-linkedin"><span class="contact-icon fa fa-linkedin"></span> LinkedIn</a></div>
                                                                                    </div>
                    </div> -->
 ...
 -->
						...
						<div>
							<c:if test="${result eq 'true'}">
								<script>
	    					     alert("<h4>We have received your request we will contact you soon...</h4>");
   								</script>
							</c:if>
						</div>
						<form class="contactPageForm" action="saveContactUs.htm">
							<input type="hidden" id="company_email" name="company_email"
								value="n3sty.marius@gmail.com">
							<div class="row">
							...
							<div class="row">
								<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
									<div class="form-group">
										<label for="cp_subject">Subject <span class="text-red">*</span></label>
										<input type="text" id="cp_subject" name="cp_subject"
							...
							<div class="row">
								<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
									<div class="form-group">
										...
										<textarea id="cp_message" name="cp_message"
											placeholder="Type your message" rows="3" class="form-control"></textarea>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
									<div class="form-group">
										<!-- <a href="javascript:void(0);" class="btn btn-green"
											id="sendContactMessageBtn">Send Message</a> -->
										<button class="btn btn-green" type="submit">Send
											Message</button>
									</div>
								</div>
							</div>
							<input type="hidden" id="securityContactPage"
								name="securityContactPage" value="fd39a7bcc6" /><input
								type="hidden" name="_wp_http_referer"
								value="/themes/reales-wp/contact-us/" />
						</form>
					</div>
					...
					<div class="content-sidebar">
						<ul class="sidebar-list">
							...
							<li id="recent_properties_widget-3"
								...
								</c:if> <c:if test="${not empty projectList}">
							...
							<li id="featured_agents_widget-4"
								class="widget-container featured_agents_sidebar"><h3
									class="osLight sidebar-header">Our Agents</h3> <c:if
									test="${empty agentList}">
									<div>
										<h4 class="pageHeader">
											<span style="color: red;">${NOAGENTSFOUND}</span>
										</h4>
									</div>
								</c:if> <c:if test="${not empty agentList}">
...
<li id="menu-item-601" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-601"><a href="${pageContext.request.contextPath}/resources/PropertyPortal/assets/search-results/indexea21.html?search_city=San+Francisco&amp;search_lat=37.7749295&amp;search_lng=-122.41941550000001&amp;search_category=0&amp;search_type=0&amp;search_min_price=&amp;search_max_price=700000">Search by Price: Less than $70,000</a></li>
				...
				<%-- <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
        <ul class="footer-nav pb20">
            <li id="recent_properties_widget-4" class="widget-container recent_properties_sidebar"><h3 class="osLight footer-header">Recently Listed Properties</h3><div class="propsWidget"><ul class="propList"><li><a href="${pageContext.request.contextPath}/resources/PropertyPortal/assets/properties/modern-residence/index.html"><div class="image"><img src="${pageContext.request.contextPath}/resources/PropertyPortal/assets/wp-content/uploads/2014/12/bg-1.jpg" alt="Recently Listed Properties" /></div><div class="info text-nowrap"><div class="name">Modern Residence</div><div class="address">547 35th Ave, San Francisco, 94121, United States</div><div class="price">$1,495,000 <span class="badge">For Sale</span></div></div><div class="clearfix"></div></a></li><li><a href="${pageContext.request.contextPath}/resources/PropertyPortal/assets/properties/sophisticated-residence/index.html"><div class="image"><img src="${pageContext.request.contextPath}/resources/PropertyPortal/assets/wp-content/uploads/2015/02/img-prop.jpg" alt="Recently Listed Properties" /></div><div class="info text-nowrap"><div class="name">Sophisticated Residence</div><div class="address">600 40th Ave, San Francisco, 94121, United States</div><div class="price">$799,000 <span class="badge">For Sale</span></div></div><div class="clearfix"></div></a></li><li><a href="${pageContext.request.contextPath}/resources/PropertyPortal/assets/properties/luxury-mansion/index.html"><div class="image"><img src="${pageContext.request.contextPath}/resources/PropertyPortal/assets/wp-content/uploads/2014/12/bg-5-1024x576.jpg" alt="Recently Listed Properties" /></div><div class="info text-nowrap"><div class="name">Luxury Mansion</div><div class="address">10 Romain St, San Francisco, 123456, Romania</div><div class="price">$3,400/mo <span class="badge">For Rent</span></div></div><div class="clearfix"></div></a></li></ul></div></li>        </ul>
    </div>
 --%>
				<%-- <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
        <ul class="footer-nav pb20">
...
<!-- Mirrored from mariusn.com/themes/reales-wp/contact-us/ by HTTrack Website Copier/3.x [XR&CO'2013], Fri, 25 Sep 2015 12:40:23 GMT -->
</html>