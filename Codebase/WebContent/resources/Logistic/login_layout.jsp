...
<!-- Mirrored from www.keenthemes.com/preview/metronic/theme/templates/admin3/login_3.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 19 Aug 2015 18:13:33 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
<meta charset="utf-8"/>
<title>Logiware | Login Form</title>
...
<link href="${pageContext.request.contextPath}/resources/Logistic/assets/global/plugins/select2/select2.css" rel="stylesheet" type="text/css"/>
<link href="${pageContext.request.contextPath}/resources/Logistic/assets/admin/pages/css/login3.css" rel="stylesheet" type="text/css"/>
...
<link href="${pageContext.request.contextPath}/resources/Logistic/assets/admin/layout/css/layout.css" rel="stylesheet" type="text/css"/>
<link href="${pageContext.request.contextPath}/resources/Logistic/assets/admin/layout/css/themes/default.css" rel="stylesheet" type="text/css" id="style_color"/>
<link href="${pageContext.request.contextPath}/resources/Logistic/assets/admin/layout/css/custom.css" rel="stylesheet" type="text/css"/>
<!-- END THEME STYLES -->
...
<script src="${pageContext.request.contextPath}/resources/Logistic/assets/global/plugins/jquery-validation/js/jquery.validate.min.js" type="text/javascript"></script>
...
<script src="${pageContext.request.contextPath}/resources/Logistic/assets/admin/layout/scripts/layout.js" type="text/javascript"></script>
<script src="${pageContext.request.contextPath}/resources/Logistic/assets/admin/layout/scripts/demo.js" type="text/javascript"></script>
<script src="${pageContext.request.contextPath}/resources/Logistic/assets/admin/pages/scripts/login.js" type="text/javascript"></script>
<!-- END PAGE LEVEL SCRIPTS -->
<script>
