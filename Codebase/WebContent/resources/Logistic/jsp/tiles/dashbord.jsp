					...
					<div class="portlet light ">
						...
						<div class="portlet-body">
							...
							<div class="table-scrollable table-scrollable-borderless">
								...
								<tr>
									<td class="fit">
										<img class="user-pic" src="${pageContext.request.contextPath}/resources/Logistic/assets/admin/layout3/img/avatar4.jpg">
									</td>
									<td>
								...
								<tr>
									<td class="fit">
										<img class="user-pic" src="${pageContext.request.contextPath}/resources/Logistic/assets/admin/layout3/img/avatar5.jpg">
									</td>
									<td>
								...
								<tr>
									<td class="fit">
										<img class="user-pic" src="${pageContext.request.contextPath}/resources/Logistic/assets/admin/layout3/img/avatar6.jpg">
									</td>
									<td>
								...
								<tr>
									<td class="fit">
										<img class="user-pic" src="${pageContext.request.contextPath}/resources/Logistic/assets/admin/layout3/img/avatar7.jpg">
									</td>
									<td>
							...
							<div class="scroller" style="height: 305px;" data-always-visible="1" data-rail-visible1="0" data-handle-color="#D7DCE2">
								<div class="general-item-list">
									<div class="item">
										<div class="item-head">
											<div class="item-details">
												<img class="item-pic" src="${pageContext.request.contextPath}/resources/Logistic/assets/admin/layout3/img/avatar4.jpg">
									...
									<div class="item">
										<div class="item-head">
											<div class="item-details">
												<img class="item-pic" src="${pageContext.request.contextPath}/resources/Logistic/assets/admin/layout3/img/avatar3.jpg">
									...
									<div class="item">
										<div class="item-head">
											<div class="item-details">
												<img class="item-pic" src="${pageContext.request.contextPath}/resources/Logistic/assets/admin/layout3/img/avatar6.jpg">
												<a href="#" class="item-name primary-link">Nick Larson</a>
									...
									<div class="item">
										<div class="item-head">
											<div class="item-details">
												<img class="item-pic" src="${pageContext.request.contextPath}/resources/Logistic/assets/admin/layout3/img/avatar7.jpg">
												<a href="#" class="item-name primary-link">Nick Larson</a>
									...
									<div class="item">
										<div class="item-head">
											<div class="item-details">
												<img class="item-pic" src="${pageContext.request.contextPath}/resources/Logistic/assets/admin/layout3/img/avatar9.jpg">
									...
									<div class="item">
										<div class="item-head">
											<div class="item-details">
												<img class="item-pic" src="${pageContext.request.contextPath}/resources/Logistic/assets/admin/layout3/img/avatar8.jpg">
									...
									<div class="item">
										<div class="item-head">
											<div class="item-details">
												<img class="item-pic" src="${pageContext.request.contextPath}/resources/Logistic/assets/admin/layout3/img/avatar2.jpg">
					...
					<div class="portlet light ">
						...
						<div class="portlet-body">
							<div id="region_statistics_loading">
								<img src="${pageContext.request.contextPath}/resources/Logistic/assets/admin/layout/img/loading.gif" alt="loading"/>
							</div>
							...
							<div class="page-quick-sidebar-chat-users" data-rail-color="#ddd" data-wrapper-class="page-quick-sidebar-list">
								...
								<ul class="media-list list-items">
									<li class="media">
										...
										<img class="media-object" src="${pageContext.request.contextPath}/resources/Logistic/assets/admin/layout/img/avatar3.jpg" alt="...">
									...
									<li class="media">
										<img class="media-object" src="${pageContext.request.contextPath}/resources/Logistic/assets/admin/layout/img/avatar1.jpg" alt="...">
										<div class="media-body">
									...
									<li class="media">
										...
										<img class="media-object" src="${pageContext.request.contextPath}/resources/Logistic/assets/admin/layout/img/avatar4.jpg" alt="...">
										<div class="media-body">
									...
									<li class="media">
										<img class="media-object" src="${pageContext.request.contextPath}/resources/Logistic/assets/admin/layout/img/avatar2.jpg" alt="...">
										<div class="media-body">
								...
								<ul class="media-list list-items">
									<li class="media">
										...
										<img class="media-object" src="${pageContext.request.contextPath}/resources/Logistic/assets/admin/layout/img/avatar6.jpg" alt="...">
										<div class="media-body">
									...
									<li class="media">
										...
										<img class="media-object" src="${pageContext.request.contextPath}/resources/Logistic/assets/admin/layout/img/avatar7.jpg" alt="...">
										<div class="media-body">
									...
									<li class="media">
										<img class="media-object" src="${pageContext.request.contextPath}/resources/Logistic/assets/admin/layout/img/avatar8.jpg" alt="...">
										<div class="media-body">
									...
									<li class="media">
										...
										<img class="media-object" src="${pageContext.request.contextPath}/resources/Logistic/assets/admin/layout/img/avatar9.jpg" alt="...">
										<div class="media-body">
									...
									<li class="media">
										<img class="media-object" src="${pageContext.request.contextPath}/resources/Logistic/assets/admin/layout/img/avatar10.jpg" alt="...">
										<div class="media-body">
									...
									<li class="media">
										...
										<img class="media-object" src="${pageContext.request.contextPath}/resources/Logistic/assets/admin/layout/img/avatar11.jpg" alt="...">
										<div class="media-body">
							...
							<div class="page-quick-sidebar-item">
								<div class="page-quick-sidebar-chat-user">
									...
									<div class="page-quick-sidebar-chat-user-messages">
										<div class="post out">
											<img class="avatar" alt="" src="${pageContext.request.contextPath}/resources/Logistic/assets/admin/layout/img/avatar3.jpg"/>
											<div class="message">
										...
										<div class="post in">
											<img class="avatar" alt="" src="${pageContext.request.contextPath}/resources/Logistic/assets/admin/layout/img/avatar2.jpg"/>
											<div class="message">
												<span class="arrow"></span>
