						...
						<div class="tab-pane" id="tab_2">
							<div class="portlet box green">
								...
								<div class="portlet-body form">
									<!-- BEGIN FORM-->
									<form:form action="saveCity.htm" modelAttribute="city" class="form-horizontal" >
									<form:hidden path="id" />
											...
											<div class="row">
												...
												<div class="col-md-6">
													<div class="form-group">
														...
														<div class="col-md-9">
															<form:select path="stateId" class="select2me form-control" >
																<form:option value="0" label="-- Select -- "/>
																 <form:options itemValue="id" itemLabel="stateName" items="${lStates}"/>
																</form:select>
														</div>
													</div>
												</div>
