						...
						<div class="portlet-body">
							<div class="table-toolbar">
								<div class="row">
									<div class="col-md-6">
										<div class="btn-group">
											<a href="showAddContractCompProduct.htm?compId=${contractCompId}"><button
													class="btn btn-circle btn-primary">Add New</button></a>
										</div>
									</div>
								 	<form:form name="compProductForm" modelAttribute="productComapany"><!-- action="getAllContractCompProducts.htm" -->
								 	<div class="col-md-6">
										<div class="">
											<form:select id="mySelect" path="compId" class="form-control" onchange="getAllCompanyProducts()">
...
<script>
function getAllCompanyProducts() {
    var x = document.getElementById("mySelect").value;
  alert(""+x);
    	 document.compProductForm.action="getAllContractCompRoutes.htm?compId="+x;
    	 document.compProductForm.method="GET";
    	 document.compProductForm.submit();
}
</script>
