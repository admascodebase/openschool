													...
													<div class="col-md-6">
														<div class="form-group">
															<label class="control-label col-md-3">Truck
																Name</label>
															<div class="col-md-9">
																<form:input type="text" path="truckName" class="form-control"
												...
												<div class="row">
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
															<form:input path="wheelsNo" type="text" class="form-control" placeholder="Enter Number Of Wheels"/>
															</div>
														</div>
													</div>
													<!--/span-->
												...
												<div class="row">
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<form:input path="maxCapacity" type="text" class="form-control" placeholder="Max Capacity"/>
															</div>
														</div>
													</div>
												</div>
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<form:input path="capacity" type="text" class="form-control" placeholder="capacity"/>
															</div>
														</div>
													</div>
